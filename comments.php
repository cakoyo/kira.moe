...
<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
    <div class="send-comment">
        ...
        <div class="reply-info reply-info-closed">
            <div class="left">您正在回复给 <a id="reply-name">Poi</a>：</div>
        ...
        <div id="<?php $this->respondId(); ?>" class="respond">
            <textarea rows=8 name="text" id="textarea" class="textarea" placeholder="" required><?php $this->remember('text'); ?></textarea>
    ...
    <div class="extra">
        <?php if($this->user->hasLogin()): ?>
            ...
            <!-- hidden inputs to initialize value for logged user -->
